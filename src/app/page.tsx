        ...
        <div className="container mx-auto px-4 py-12 md:py-20">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12 mb-20">
            <div className="flex-1 max-w-2xl">
              <h1 className="text-4xl md:text-6xl font-bold mb-4 leading-tight text-[#f97316] px-4 md:px-0 text-center md:text-left">
                Daily Bitcoin News.
                <br />
                Less Crypto Chaos.
              </h1>
              <p className="text-xl mb-8 text-[#c2410c] px-4 md:px-0 text-center md:text-left">
